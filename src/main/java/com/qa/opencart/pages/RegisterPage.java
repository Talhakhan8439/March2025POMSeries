...
public class RegisterPage {
	...
	public boolean userRegister(String firstName, String lastName, String email, String telephone, String password , String subscribe) {
		...
		eleUtil.waitForElementPresence(this.firstName, AppConstants.DEFAULT_SHORT_WAIT).sendKeys(firstName);
		...
		String successMesg  =eleUtil.waitForElementPresence(successMessg, AppConstants.DEFAULT_SHORT_WAIT).getText();
